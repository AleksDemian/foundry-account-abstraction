...
contract SendPackedUserOp is Script {
  ...
  function run() public {
    ...
    address dest = 0xaf88d065e77c8cC2239327C5EDb3A432268e5831; // arbitrum USDC address
    uint256 value = 0;
    bytes memory functionData = abi.encodeWithSelector(IERC20.approve.selector, 0x3b29236323d90e62782737eAEF81A2dFdbfB95fD, 1e18);
    bytes memory executeCalldata = abi.encodeWithSelector(MinimalAccount.execute.selector, dest, value, functionData);
    PackedUserOperation memory userOp = generatedSignedUserOperation(executeCalldata, helperConfig.getConfig(), 0x60d9aA4E11d72004E2e6EF37eECD282cEec51521);
